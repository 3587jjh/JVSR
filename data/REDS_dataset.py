...
class REDSDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # extract patch (random crop) for training
        ...
        for i in range(key-self.N, key+self.N+1):
            ...
            assert img_HR.shape[0]%self.scale==0 and img_HR.shape[1]%self.scale==0
            # HR to LR
            img_HR = cv2.GaussianBlur(img_HR, (5,5), 1.5)
        ...
        return {'LRs': img_LRs, 'GT': img_GT, 'video': v, 'key': key}
